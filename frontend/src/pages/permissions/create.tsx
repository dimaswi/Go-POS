              ...
              <div className="space-y-2">
                ...
                <Popover open={openAction} onOpenChange={setOpenAction}>
                  <PopoverTrigger asChild>
                    ...
                    >
                      {formData.action
                        ? actionOptions.find((a) => a.id === formData.action)?.label || "Pilih action"
                        : "Pilih action"}
                      <ChevronsUpDown className="ml-2 h-4 w-4 shrink-0 opacity-50" />
                    </Button>
                  </PopoverTrigger>
                  ...
                  >
                    <Command>
                      <CommandInput placeholder="Cari action..." />
                      <CommandList>
                        <CommandEmpty>Action tidak ditemukan.</CommandEmpty>
                        <CommandGroup>
                          {actionOptions.map((action) => (
                            <CommandItem
                              ...
                              onSelect={() => {
                                setFormData({ ...formData, action: action.id });
                                setOpenAction(false);
                              }}
                            >
                              <Check
