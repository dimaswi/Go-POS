...
export default function RoleEdit() {
  ...
  // Don't render until we have data and a selected module
  if (fetching || !selectedModule) {
    return (
          ...
          <div className="flex items-center gap-2">
            ...
            <div className="flex-1 min-w-0">
              ...
              <CardDescription className="text-xs hidden sm:block">
                Ubah nama, deskripsi, dan permissions untuk role ini
              </CardDescription>
            </div>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="flex flex-col md:flex-row min-h-[400px] sm:min-h-[500px]">
              ...
              <div className="w-full md:w-56 lg:w-64 flex-shrink-0 border-b md:border-b-0 md:border-r bg-muted/30">
                ...
                <ScrollArea className="h-[180px] md:h-[400px] lg:h-[455px]">
