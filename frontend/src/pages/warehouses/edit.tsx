...
export default function WarehouseEdit() {
  ...
  const loadWarehouse = async () => {
    ...
    try {
      ...
      setFormData({
        ...
        manager_id: warehouse.manager_id ? warehouse.manager_id.toString() : "",
        store_id: warehouse.store_id ? warehouse.store_id.toString() : "",
      ...
      toast({
        variant: "destructive",
        title: "Error!",
        description: error.response?.data?.error || "Failed to load warehouse.",
      });
      navigate("/warehouses");
    } finally {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await warehousesApi.update(parseInt(id), {
        ...formData,
      ...
      toast({
        variant: "destructive",
        title: "Error!",
        description: error.response?.data?.error || "Failed to update warehouse.",
      });
    } finally {
      setLoading(false);
    }
