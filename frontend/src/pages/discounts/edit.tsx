...
export default function EditDiscountPage() {
  ...
  const loadData = async () => {
    ...
    try {
      ...
      setFormData({
        ...
        start_date: discount.start_date ? format(new Date(discount.start_date), 'yyyy-MM-dd') : '',
        end_date: discount.end_date ? format(new Date(discount.end_date), 'yyyy-MM-dd') : '',
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await discountsApi.update(parseInt(id!), payload);
      toast({
        variant: "success",
        title: "Berhasil!",
      ...
      toast({
        variant: "destructive",
        title: "Error!",
        description: error.response?.data?.error || "Gagal memperbarui diskon.",
      });
    } finally {
      setSaving(false);
    }
            ...
            <CardHeader className="border-b bg-muted/50">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <CardTitle className="text-xl">Edit Diskon</CardTitle>
                    <CardDescription>
